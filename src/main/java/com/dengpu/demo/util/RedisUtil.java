...
public final class RedisUtil {
	...
	static {
		try {
			...
			jedisPool = new JedisPool(config,bundle.getString("redis.ip=127.0.0.1"),
					Integer.parseInt(bundle.getString("redis.port")),Integer.parseInt(bundle.getString("redis.timeout")));// 如果你的redis设置了密码，在创建时添加AUTH参数
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
